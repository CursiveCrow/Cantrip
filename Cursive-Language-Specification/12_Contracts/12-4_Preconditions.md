...
**Section**: §12.4 Preconditions: must
...
#### §12.4.2 Syntax [contract.precondition.syntax]
...
#### §12.4.3 Constraints [contract.precondition.constraints]
...
#### §12.4.4 Semantics [contract.precondition.semantics]

##### §12.4.4.1 Caller Obligation
...
##### §12.4.4.4 Control-Flow Sensitive Verification
...
#### §12.4.5 Multiple Preconditions [contract.precondition.multiple]
...
#### §12.4.6 Preconditions in Contracts [contract.precondition.contracts]
...
#### §12.4.7 Diagnostics [contract.precondition.diagnostics]
...
#### §12.4.8 Conformance Requirements [contract.precondition.requirements]
