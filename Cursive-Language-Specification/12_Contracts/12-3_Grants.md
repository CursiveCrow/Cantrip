...
**Clause**: 12 — Contracts
**File**: 12-3_Grants.md
**Section**: §12.3 Grants (within Sequent)
...
### §12.3 Grants (within Sequent) [contract.grant]
...
#### §12.3.2 Syntax [contract.grant.syntax]
...
#### §12.3.3 Built-In Grant Catalog [contract.grant.builtin]

[7] Implementations shall provide at least the following built-in grants:

##### §12.3.3.1 Allocation Grants
...
##### §12.3.3.7 Unsafe and FFI Grants
...
#### §12.3.4 User-Defined Grants [contract.grant.user]
...
#### §12.3.5 Grant Subsumption [contract.grant.subsumption]
...
#### §12.3.6 Grant Composition [contract.grant.composition]
...
#### §12.3.7 Grant Polymorphism [contract.grant.polymorphism]
...
#### §12.3.8 Grant Checking [contract.grant.checking]
...
#### §12.3.9 Constraints [contract.grant.constraints]
...
#### §12.3.10 Semantics [contract.grant.semantics]

##### §12.3.10.1 Grant Availability
...
##### §12.3.10.3 Grant Parameter Substitution
...
#### §12.3.11 Intrinsic Operation Grants [contract.grant.intrinsic]
...
#### §12.3.12 Examples [contract.grant.examples]
...
#### §12.3.13 Diagnostics [contract.grant.diagnostics]
...
#### §12.3.14 Conformance Requirements [contract.grant.requirements]
