...
**Section**: §16.4 Comptime Intrinsics and Configuration  
...
### §16.4 Comptime Intrinsics and Configuration [comptime.intrinsics]

#### §16.4.1 Overview [comptime.intrinsics.overview]
...
#### §16.4.2 Assertion and Validation Intrinsics [comptime.intrinsics.assertions]

##### §16.4.2.1 comptime_assert
...
- If `condition == false`: Compilation fails with diagnostic E16-030 and the provided `message`
...
$$
\frac{\langle condition, \sigma_{\text{ct}} \rangle \Downarrow_{\text{ct}} \langle \texttt{false}, \sigma_{\text{ct}} \rangle}{\langle \texttt{comptime\_assert}(condition, message), \sigma_{\text{ct}} \rangle \Downarrow_{\text{ct}} \text{ERROR E16-030}}
\tag{E-Assert-Fail}
$$
...
#### §16.4.3 Configuration Query Intrinsics [comptime.intrinsics.config]

##### §16.4.3.1 Boolean Configuration Queries
...
##### §16.4.3.2 String Configuration Queries
...
##### §16.4.3.3 Platform Query Intrinsics
...
##### §16.4.3.4 Platform-Conditional Code
...
#### §16.4.4 Type Property Intrinsics [comptime.intrinsics.types]

##### §16.4.4.1 Basic Type Queries
...
[28] Returns the size of type `T` in bytes (§3.5, §11.6).
...
##### §16.4.4.2 Type Property Predicates
...
- `is_sized<T>()`: Returns `true` if `T` is a sized type (§3.2.3.1)
...
#### §16.4.5 Utility Intrinsics [comptime.intrinsics.utilities]

##### §16.4.5.1 String Manipulation
...
#### §16.4.6 Comprehensive Examples [comptime.intrinsics.examples]

##### §16.4.6.1 Configuration-Driven Code Generation
...
##### §16.4.6.2 Platform-Specific Optimization
...
#### §16.4.7 Diagnostics [comptime.intrinsics.diagnostics]

[37] Intrinsic-related diagnostics:

**Table 16.4 — Comptime intrinsic diagnostics**

| Code    | Condition                         | Section |
| ------- | --------------------------------- | ------- |
| E16-030 | Comptime assertion failed         | [7]     |
| E16-031 | Comptime error (fatal)            | [10]    |
| E16-032 | Comptime warning (non-fatal)      | [12]    |
| E16-040 | Configuration key not found       | N/A     |
| E16-041 | Platform query in runtime context | N/A     |

#### §16.4.8 Conformance Requirements [comptime.intrinsics.requirements]
