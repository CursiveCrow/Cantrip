...
**Section**: §16.7 Quote Expressions and Interpolation  
...
### §16.7 Quote Expressions and Interpolation [comptime.quote]

#### §16.7.1 Overview [comptime.quote.overview]
...
#### §16.7.2 Syntax [comptime.quote.syntax]
...
#### §16.7.3 Constraints [comptime.quote.constraints]

##### §16.7.3.1 Context Requirements
...
##### §16.7.3.2 Interpolation Constraints
...
##### §16.7.3.3 Quoted Code Constraints
...
#### §16.7.4 Semantics [comptime.quote.semantics]

##### §16.7.4.1 Quote Evaluation
...
##### §16.7.4.2 Interpolation Resolution
...
##### §16.7.4.4 Identifier Interpolation
...
##### §16.7.4.5 Array and Tuple Interpolation
...
#### §16.7.5 Examples [comptime.quote.examples]

##### §16.7.5.1 Simple Value Interpolation
...
##### §16.7.5.2 Identifier Interpolation
...
##### §16.7.5.3 Combined Interpolation
...
##### §16.7.5.4 Quote in Procedure Spec
...
#### §16.7.6 Interpolation Type Safety [comptime.quote.typesafety]

##### §16.7.6.1 Type Preservation
...
#### §16.7.7 Diagnostics [comptime.quote.diagnostics]

[28] Quote expression diagnostics:

**Table 16.7 — Quote expression diagnostics**

| Code    | Condition                                           | Constraint |
| ------- | --------------------------------------------------- | ---------- |
| E16-200 | Quote expression in runtime context                 | [8]        |
| E16-201 | Interpolation expression not compile-time evaluable | [10]       |
| E16-202 | Interpolated value type not embeddable              | [12]       |
| E16-203 | Generated code fails type checking                  | [14]       |

#### §16.7.8 Conformance Requirements [comptime.quote.requirements]
