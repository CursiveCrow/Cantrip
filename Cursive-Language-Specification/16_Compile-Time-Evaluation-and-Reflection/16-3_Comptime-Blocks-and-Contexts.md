...
**Section**: §16.3 Comptime Blocks and Contexts  
**Stable label**: [comptime.blocks]  
**Forward references**: §16.2 [comptime.procedures], §16.4 [comptime.intrinsics], §16.8 [comptime.codegen.api], Clause 2 §2.2 [lex.phases], Clause 4 §4.6 [module.initialization], Clause 6 §6.2 [name.scope], Clause 8 §8.7 [expr.constant], Annex A §A.4 [grammar.expression]

---

### §16.3 Comptime Blocks and Contexts [comptime.blocks]

#### §16.3.1 Overview [comptime.blocks.overview]
...
#### §16.3.2 Syntax [comptime.blocks.syntax]
...
#### §16.3.3 Constraints [comptime.blocks.constraints]

##### §16.3.3.1 Grant Accumulation
...
[8] All accumulated grants must be comptime-safe. Any runtime grant produces diagnostic E16-001.

##### §16.3.3.2 Scope Isolation
...
[10] Attempting to reference comptime bindings from runtime code produces diagnostic E16-020 (undefined identifier, via standard name resolution).
...
##### §16.3.3.3 Result Type Constraints
...
##### §16.3.3.4 Module-Scope Placement
...
#### §16.3.4 Semantics [comptime.blocks.semantics]

##### §16.3.4.1 Evaluation Model
...
$$
\frac{\exists \text{ cycle in comptime dependency graph}}{\text{ERROR E16-021: cyclic comptime dependency}}
\tag{WF-Comptime-Acyclic}
$$

[20] Cyclic dependencies among comptime blocks are ill-formed and produce diagnostic E16-021.

##### §16.3.4.3 Statement Execution

[21] Statements within comptime blocks execute sequentially in textual order, following the execution model in Clause 9. Side effects visible during comptime evaluation include:
...
#### §16.3.5 Examples [comptime.blocks.examples]

##### §16.3.5.1 Conditional Compilation
...
##### §16.3.5.2 Compile-Time Assertions
...
#### §16.3.6 Comptime Blocks at Module Scope [comptime.blocks.module]

##### §16.3.6.1 Module Initialization Integration
...
##### §16.3.6.2 Code Generation at Module Scope
...
#### §16.3.7 Comptime Blocks in Procedure Bodies [comptime.blocks.local]

##### §16.3.7.1 Local Comptime Computation
...
##### §16.3.7.2 Conditional Assertions
...
#### §16.3.8 Diagnostics [comptime.blocks.diagnostics]

[28] Comptime block diagnostics:

**Table 16.3 — Comptime block diagnostics**

| Code    | Condition                                     | Constraint |
| ------- | --------------------------------------------- | ---------- |
| E16-001 | Runtime grant in comptime block               | [8]        |
| E16-020 | Comptime binding referenced from runtime code | [10]       |
| E16-021 | Cyclic dependency in comptime blocks          | [19]       |
| E16-022 | Comptime block result type not representable  | [12]       |

#### §16.3.9 Conformance Requirements [comptime.blocks.requirements]
...
7. Detect cyclic dependencies and emit diagnostic E16-021
...
10. Emit diagnostics E16-001, E16-020, E16-021, E16-022 for violations
