...
**Section**: §11.6 Layout and Alignment  
**Stable label**: [memory.layout]  
**Forward references**: Clause 3 §3.5 [basic.align], Clause 5 §5.5 [decl.type], Clause 7 §7.3 [type.composite], Clause 15 [interop]

---

### §11.6 Layout and Alignment [memory.layout]

#### §11.6.1 Overview

[1] This section completes the layout and alignment specification introduced in Clause 3 §3.5. It provides normative rules for calculating sizes, alignments, field offsets, and padding for all type categories.
...
#### §11.6.2 Alignment Rules [memory.layout.alignment]

##### §11.6.2.1 Alignment Definition
...
#### §11.6.3 Size and Layout [memory.layout.size]

##### §11.6.3.1 Size Calculation
...
#### §11.6.4 Representation Attributes [memory.layout.repr]
...
#### §11.6.6 Conformance Requirements
