...
**Section**: §15.2 FFI-Specific Unsafe Usage  
...
### §15.2 FFI-Specific Unsafe Usage [interop.unsafe]
...
#### §15.2.2 Raw Pointers in FFI Context

##### §15.2.2.1 Pointer Validity Obligations
...
#### §15.2.3 Memory Lifetime Management

##### §15.2.3.1 Stack Pointers to Foreign Code
...
##### §15.2.3.2 Foreign-Allocated Memory
...
##### §15.2.3.3 Region-Allocated Data to Foreign Code
...
#### §15.2.4 Panic and Unwinding

##### §15.2.4.1 Default Abort Behavior
...
#### §15.2.6 Calling Convention Mismatch
...
#### §15.2.9 Conformance Requirements
