...
### §15.4 Platform-Specific Features [interop.platform]
...
#### §15.4.2 Platform-Conditional Compilation

##### §15.4.2.1 Comptime Platform Queries
...
##### §15.4.2.2 Available Platform Queries
...
##### §15.4.2.3 Comptime Code Generation
...
#### §15.4.3 Inline Assembly (Future Edition)
...
#### §15.4.4 SIMD Intrinsics (Future Edition)
...
#### §15.4.5 Platform-Specific Attributes
...
#### §15.4.8 Conformance Requirements
