...
**Forward references**: §15.1 [interop.ffi], §15.6 [interop.abi], Clause 3 §3.5 [basic.align], Clause 5 §5.5 [decl.type], Clause 7 §7.3 [type.composite], Clause 11 §11.6 [memory.layout]

---

### §15.3 C Compatibility [interop.c]
...
#### §15.3.2 Type Representation Compatibility
...
##### §15.3.2.3 repr(C) Enum Representation
...
#### §15.3.3 String Conversion

##### §15.3.3.1 Null-Terminated String Attribute
...
##### §15.3.3.2 String Conversion Methods
...
##### §15.3.3.3 String Lifetime Obligations
...
#### §15.3.4 Function Pointers and Callbacks

##### §15.3.4.1 Extern Procedure Pointers
...
##### §15.3.4.3 Callback Safety Obligations
...
#### §15.3.5 Size and Alignment Compatibility
...
#### §15.3.8 Conformance Requirements
