...
**Section**: §15.7 Binary Compatibility  
...
#### §15.7.2 ABI Stability

##### §15.7.2.1 No Guaranteed Binary Compatibility
...
##### §15.7.2.2 Implementation-Defined Stability
...
##### §15.7.2.3 Explicit ABI Versioning
...
#### §15.7.3 Breaking Changes

##### §15.7.3.1 ABI-Breaking Changes
...
| ------- | -------------------------------------------------- | ------- |
| E15-090 | Link-time symbol conflict (ODR violation detected) | [10]    |
| E15-091 | ABI version mismatch                               | [8]     |
| E15-092 | Incompatible object file format                    | [15]    |

These are link-time or load-time errors, not compile-time.

#### §15.7.10 Conformance Requirements
