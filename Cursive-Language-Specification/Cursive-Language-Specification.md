...
- [Part I - Conformance, Diagnostics, and Governance](#part-i---conformance-diagnostics-and-governance)
  ...
  - [8. Governance \[governance\]](#8-governance-governance)
    - [8.1 Extension System \[governance.extensions\]](#81-extension-system-governanceextensions)
    - [8.2 Versioning and Compatibility \[governance.versioning\]](#82-versioning-and-compatibility-governanceversioning)
    - [8.3 Deprecation and Evolution \[governance.deprecation\]](#83-deprecation-and-evolution-governancedeprecation)
    - [8.4 Conformance Testing and Certification \[governance.conformance\]](#84-conformance-testing-and-certification-governanceconformance)
    - [8.5 Specification Governance \[governance.specification\]](#85-specification-governance-governancespecification)
...
This chapter specifies diagnostic reporting requirements: obligation to diagnose, code format, severity levels, and implementation-defined presentation aspects.
...
This chapter defines governance rules for language evolution, extensions, versioning, and conformance certification. It establishes how the Cursive language and specification evolve over time while maintaining stability and predictability for implementations and programs.

### 8.1 Extension System [governance.extensions]

This section defines how implementations may extend the language while preserving portability and conformance.

#### 8.1.1 Extension Mechanisms [governance.extensions.mechanisms]

[Content placeholder: Define how implementations may introduce extensions, including attribute-based extensions, compiler-specific features, and experimental language features]

#### 8.1.2 Feature Flags [governance.extensions.flags]

[Content placeholder: Define feature flag syntax, manifest integration, and how features are enabled/disabled]

#### 8.1.3 Experimental Features [governance.extensions.experimental]

[Content placeholder: Define requirements and obligations for experimental features, including stability warnings and documentation]

#### 8.1.4 Extension Namespacing [governance.extensions.namespacing]

[Content placeholder: Define namespacing rules to prevent conflicts between vendor extensions and specification-defined features]

#### 8.1.5 Extension Conformance [governance.extensions.conformance]

[Content placeholder: Define when programs using extensions are conforming, and documentation requirements for extension behavior]

### 8.2 Versioning and Compatibility [governance.versioning]

This section defines version numbering, compatibility guarantees, and edition systems.

#### 8.2.1 Specification Versioning Policy [governance.versioning.policy]

[Content placeholder: Formalize semantic versioning rules for the specification itself, defining what constitutes MAJOR, MINOR, and PATCH changes]

#### 8.2.2 Language Editions [governance.versioning.editions]

[Content placeholder: Define edition system for managing incompatible changes while allowing legacy code to compile]

#### 8.2.3 Backward Compatibility Requirements [governance.versioning.backward]

[Content placeholder: Define what guarantees implementations must provide for programs written against older specification versions]

#### 8.2.4 Forward Compatibility Strategy [governance.versioning.forward]

[Content placeholder: Define how implementations should handle code using newer specification features]

#### 8.2.5 Version Declaration [governance.versioning.declaration]

[Content placeholder: Define how programs declare their target language version in manifests and source files]

### 8.3 Deprecation and Evolution [governance.deprecation]

This section defines how features are deprecated and eventually removed from the language.

#### 8.3.1 Deprecation Timeline [governance.deprecation.timeline]

[Content placeholder: Define minimum time periods between deprecation warning and feature removal]

#### 8.3.2 Deprecation Warning Requirements [governance.deprecation.warnings]

[Content placeholder: Define diagnostic requirements for deprecated features using the annotation system from §2.2]

#### 8.3.3 Removal Process [governance.deprecation.removal]

[Content placeholder: Define the formal process for removing deprecated features, including specification version requirements]

#### 8.3.4 Migration Path Documentation [governance.deprecation.migration]

[Content placeholder: Define requirements for documenting migration paths when features are deprecated]

#### 8.3.5 Critical Security Deprecation [governance.deprecation.security]

[Content placeholder: Define expedited deprecation process for features with security implications]

### 8.4 Conformance Testing and Certification [governance.conformance]

This section defines requirements for conformance testing and implementation certification.

#### 8.4.1 Conformance Test Suite [governance.conformance.testsuite]

[Content placeholder: Define requirements for reference conformance test suite structure and coverage]

#### 8.4.2 Test Categories [governance.conformance.categories]

[Content placeholder: Define positive tests, negative tests, and behavioral tests required for conformance]

#### 8.4.3 Implementation Certification [governance.conformance.certification]

[Content placeholder: Define the process for certifying implementations as conforming]

#### 8.4.4 Conformance Claims [governance.conformance.claims]

[Content placeholder: Define format and requirements for conformance claims and conformance dossiers]

#### 8.4.5 Partial Conformance [governance.conformance.partial]

[Content placeholder: Define rules for subset implementations targeting embedded or restricted environments]

### 8.5 Specification Governance [governance.specification]

This section defines how the specification itself is governed and evolved.

#### 8.5.1 Change Proposal Process [governance.specification.proposals]

[Content placeholder: Define formal process for proposing changes to the specification]

#### 8.5.2 Reference Implementation Role [governance.specification.reference]

[Content placeholder: Define the role of reference implementation in validating specification changes]

#### 8.5.3 Breaking Change Policy [governance.specification.breaking]

[Content placeholder: Define when and how breaking changes may be introduced]

#### 8.5.4 Specification Errata [governance.specification.errata]

[Content placeholder: Define how errors in the specification are reported and corrected]

#### 8.5.5 Extension Adoption [governance.specification.adoption]

[Content placeholder: Define process for promoting successful extensions into the core specification]
