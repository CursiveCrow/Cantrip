...
**Section**: §13.6 Regions, Permissions, and Grants Interplay
...
#### §13.6.2 Cleanup Responsibility [witness.memory.responsibility]
...
#### §13.6.3 Region Integration [witness.memory.regions]

##### §13.6.3.1 Region Witness Lifetime
...
##### §13.6.3.2 Region Escape Prevention
...
#### §13.6.4 Permission Inheritance [witness.memory.permissions]
...
##### §13.6.4.1 Permission Downgrades
...
#### §13.6.5 Move Semantics [witness.memory.move]
...
#### §13.6.6 Grant Requirements [witness.memory.grants]
...
#### §13.6.7 Witness Transitions [witness.memory.transitions]
...
#### §13.6.8 Conformance Requirements [witness.memory.requirements]
