...
**Section**: §4.4 Export, Import, and Re-export Interactions
**Stable label**: [module.export]  
**Forward references**: §2.5 [lex.units], §4.3 [module.scope], Clause 5 [decl], Clause 6 [name], Annex A §A.7 [grammar.declaration], Annex E §E.2.1 [implementation.algorithms]

---

### §4.4 Export, Import, and Re-export Interactions [module.export]
...
[2] Clause 5 governs the declarations themselves; this clause focuses on how visibility modifiers and `public use` statements determine the observable surface of a module.
