...
## Part XII: Pre-Submission Checklist

### 12.1 Before Each Section

- [ ] Does this section follow the standard template?
- [ ] Is the `##### Definition` block present and complete?
- [ ] Are all RFC 2119 keywords in ALL CAPS?
- [ ] Are all technical terms defined before use?
- [ ] Are formal rules preserved from the source (not replaced with prose)?

### 12.2 For Normative Content

- [ ] Does every MUST-level failure have a diagnostic code?
- [ ] Is detection time specified for each error?
- [ ] Is the failure effect specified (Rejection/Panic/Abort)?
- [ ] Are all behaviors classified (Defined/IDB/USB/UVB)?

### 12.3 For Informative Content

- [ ] Are all notes prefixed with `> **Note:**`?
- [ ] Is rationale in `> **Rationale:**` blocks, not normative prose?

### 12.4 For Lists and Tables

- [ ] Does every list have an introductory sentence?
- [ ] Do all list items have parallel grammatical structure?
- [ ] Does every table have a header row?
- [ ] Is list nesting ≤ 2 levels?

### 12.5 For the Complete Clause

- [ ] Is the clause notes section present at the end?
- [ ] Are all defined terms catalogued?
- [ ] Are all cross-references accurate?
- [ ] Is no content duplicated from other clauses?

---

## Summary

Specification prose is a precision instrument. Every word carries normative weight. Write as if your text will be parsed by a compiler: ambiguity is a bug, inconsistency is a bug, and vagueness is a bug.

**Three absolute rules:**
1. **Define once, reference everywhere** — No concept appears in two places.
2. **Formal before prose** — Type rules, grammars, and semantics use formal notation.
