...
**Version:** 0.7.0 (compatible with 0.6.x)
...
### Terminology Note
Earlier drafts used the working name “Arcane.” This specification standardizes the language name as
**Cantrip**. Text that previously read “Arcane” has been normalized to **Cantrip** without semantic change.
The historical name MAY appear in comments or examples in legacy materials; such occurrences are to be
interpreted as referring to Cantrip.
