...
[2] This clause specifies the complete memory model, including: object lifetimes and storage duration (§11.2), region-based allocation (§11.3), the permission system (§11.4), transfer semantics and binding categories (§11.5), memory layout (§11.6), aliasing rules (§11.7), and unsafe operations (§11.8).
