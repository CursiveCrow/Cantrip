...
#### §11.8.2 Unsafe Block Syntax [memory.unsafe.syntax]
...
#### §11.8.3 Unsafe Operations [memory.unsafe.operations]

##### §11.8.3.1 Operations Requiring Unsafe
...
#### §11.8.4 Safety Obligations [memory.unsafe.obligations]

##### §11.8.4.1 Programmer Responsibilities
...
##### §11.8.4.2 Unsafe Function Declaration
...
#### §11.8.5 Unsafe and FFI [memory.unsafe.ffi]

##### §11.8.5.1 FFI Integration
...
[17] FFI safety obligations are specified in Clause 15 [interop].

[ Note: Clause 15 (Interoperability and ABI) is not yet written. Complete FFI safety obligations will be specified there.
— end note ]
...
#### §11.8.7 Conformance Requirements
