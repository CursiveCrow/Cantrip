...
**Section**: §11.7 Aliasing and Uniqueness Rules  
...
#### §11.7.2 Aliasing Definition [memory.aliasing.definition]

##### §11.7.2.1 Formal Definition
...
#### §11.7.3 Unique Permission Enforcement [memory.aliasing.unique]

##### §11.7.3.1 Overview

[6] The `unique` permission guarantees exclusive access: only one `unique` binding to an object can exist at a time. The compiler enforces this through active reference tracking.

##### §11.7.3.2 Unique Exclusivity Rule
...
##### §11.7.3.3 Temporary Const Allowed
...
#### §11.7.4 Shared Permission Coordination [memory.aliasing.shared]
...
##### §11.7.4.2 Field-Level Protection
...
#### §11.7.5 Active Reference Tracking [memory.aliasing.tracking]

##### §11.7.5.1 Tracking Algorithm
...
#### §11.7.7 Conformance Requirements
