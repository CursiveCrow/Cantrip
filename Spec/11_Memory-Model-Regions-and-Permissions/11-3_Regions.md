...
#### §11.3.2 Arena Modal Type [memory.region.arena]

##### §11.3.2.1 Arena States and Structure
...
##### §11.3.2.2 Arena Allocation Methods
...
##### §11.3.2.3 Arena Reset and Lifecycle
...
#### §11.3.3 Region Block Syntax [memory.region.syntax]

##### §11.3.3.1 Region Blocks
...
##### §11.3.3.2 The Caret Operator (Syntactic Sugar)
...
#### §11.3.4 Escape Analysis [memory.region.escape]
...
##### §11.3.4.2 Provenance Metadata [memory.region.provenance]
...
#### §11.3.5 Caret Stacking for Parent Arenas [memory.region.stacking]

##### §11.3.5.1 Parent Arena Allocation
...
#### §11.3.6 Bulk Deallocation [memory.region.bulk]

##### §11.3.6.1 O(1) Deallocation
...
#### §11.3.7 Arena Passing and Pools [memory.region.pools]

##### §11.3.7.1 Passing Arenas to Procedures
...
##### §11.3.7.2 Multiple Independent Arenas
...
#### §11.3.9 Conformance Requirements
