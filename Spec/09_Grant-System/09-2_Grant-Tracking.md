...
### 9.2.4.3 Function Pointers and Closures

**Normative Statement 9.2.9**: When calling through a function pointer or closure, the caller shall possess all grants that could possibly be required by any procedure that matches the function pointer or closure type.

**Conservative Analysis**: Implementations may require callers to possess all grants declared in the function type.
...
**Forward Reference**: Complete function type specification in Part III §3.4 (Function Types).
