...
**Function Restriction**: A function shall not call any procedure that requires grants.
...
**Forward Reference**: Complete function/procedure distinction in Part IV (Functions and Procedures).
...
|---------|---------|--------|
| **Permissions** (`owned`, `unique`, `shared`, `readonly`) | Aliasing and mutation control | Type system (Part VI) |
| **Grants** (`alloc::heap`, `fs::read`, etc.) | Capability tracking | Grant system (Part IX) |
...
**Forward Reference**: Complete permission specification in Part VI (Memory Model and Permissions).
...
**Forward Reference**: Complete contract integration in Part X (Contract System).
...
**Forward Reference**: Complete region specification in Part VI §6.4 (Regions and Lifetimes).
