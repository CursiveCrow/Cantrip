...
#### §12.6.2 Type Invariants [contract.invariant.type]
...
#### §12.6.3 Loop Invariants [contract.invariant.loop]
...
##### §12.6.3.3 Loop Invariant Verification
...
#### §12.6.4 Invariant Desugaring [contract.invariant.desugaring]

##### §12.6.4.1 Type Invariant Desugaring
...
##### §12.6.4.2 Loop Invariant Desugaring
...
#### §12.6.5 Constraints [contract.invariant.constraints]
...
#### §12.6.6 Semantics [contract.invariant.semantics]

##### §12.6.6.1 Type Invariant Semantics
...
##### §12.6.6.2 Loop Invariant Semantics
...
#### §12.6.7 Automatic Invariant Checking [contract.invariant.automatic]
...
#### §12.6.8 Integration with Sequent Postconditions [contract.invariant.integration]
...
#### §12.6.9 Constraints [contract.invariant.constraints]
...
#### §12.6.10 Examples [contract.invariant.examples]
...
#### §12.6.11 Diagnostics [contract.invariant.diagnostics]
...
#### §12.6.12 Conformance Requirements [contract.invariant.requirements]
