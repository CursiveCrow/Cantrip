...
**Section**: §12.2 Sequent: Syntax and Structure
...
### §12.2 Sequent: Syntax and Structure [contract.sequent]
...
#### §12.2.2 Syntax [contract.sequent.syntax]

##### §12.2.2.1 Complete Form
...
##### §12.2.2.2 Smart Defaulting Forms
...
#### §12.2.4 Semantics [contract.sequent.semantics]

##### §12.2.4.1 Sequent Interpretation
...
#### §12.2.5 Examples [contract.sequent.examples]
...
#### §12.2.6 Integration with Procedure Declarations [contract.sequent.integration]
...
#### §12.2.7 Formal Sequent Structure [contract.sequent.formal]
...
#### §12.2.8 Diagnostics [contract.sequent.diagnostics]
