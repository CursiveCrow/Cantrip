...
**Section**: §4.5 Qualified Names and Resolution
**Stable label**: [module.qualified]  
**Forward references**: §2.3 [lex.tokens], §4.3 [module.scope], Clause 5 [decl], Clause 6 [name], Annex A §A.7 [grammar.declaration], Annex E §E.2.1 [implementation.algorithms]

---

### §4.5 Qualified Names and Resolution [module.qualified]
...
[2] Resolution depends on the module table (§4.1), scope bindings (§4.3), and export sets (§4.4).
