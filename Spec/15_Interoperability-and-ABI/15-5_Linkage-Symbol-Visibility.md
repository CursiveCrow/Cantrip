...
### §15.5 Linkage and Symbol Visibility [interop.linkage]
...
##### §15.5.2.2 Linkage Determination Rule
...
##### §15.5.3.2 External Linkage Example
...
##### §15.5.4.2 Internal Linkage Example
...
#### §15.5.5 One Definition Rule (ODR)

##### §15.5.5.1 ODR for Types
...
##### §15.5.6.2 Mangling Bypass Attributes
...
##### §15.5.6.3 Extern Implies No Mangle
...
#### §15.5.10 Conformance Requirements
