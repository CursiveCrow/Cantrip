...
**Section**: §15.6 ABI Specification  
**Stable label**: [interop.abi]  
**Forward references**: §15.3 [interop.c], §15.5 [interop.linkage], Clause 3 §3.5 [basic.align], Clause 7 §7.2 [type.primitive], Clause 11 §11.6 [memory.layout], §1.2.3 [intro.refs.abi]

---

### §15.6 ABI Specification [interop.abi]
...
##### §15.6.2.2 Supported Calling Conventions
...
##### §15.6.3.1 Primitive Type Representation
...
##### §15.6.3.2 repr(C) Structure Layout
...
#### §15.6.5 Platform-Specific ABI Details

##### §15.6.5.1 System V AMD64 ABI (Linux/Unix x86-64)
...
##### §15.6.5.2 Microsoft x64 Calling Convention (Windows x86-64)
...
##### §15.6.5.3 ARM AAPCS (ARM 32-bit and 64-bit)
...
##### §15.6.5.4 Implementation Obligations
...
#### §15.6.7 Conformance Requirements
