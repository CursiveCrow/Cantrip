...
##### §10.4.5.3 Sized Behavior [generic.behavior.marker.sized]
...
##### §10.4.5.4 Drop Behavior [generic.behavior.marker.drop]
...
##### §10.4.5.5 Marker Behavior Summary
...
#### §10.4.6 Behavior Items [generic.behavior.items]
...
#### §10.4.7 Integration with Witnesses [generic.behavior.witness]
