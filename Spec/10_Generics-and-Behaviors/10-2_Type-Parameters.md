...
### §10.2 Type Parameters [generic.parameter]
...
#### §10.2.3 Type Parameters [generic.parameter.type]

##### §10.2.3.1 Declaration and Scope
...
- Behavior declarations: `predicate Container<T> { ... }`
...
##### §10.2.3.3 Type Parameter Inference
...
#### §10.2.4 Const Parameters [generic.parameter.const]

##### §10.2.4.1 Declaration and Valid Types
...
##### §10.2.4.2 Const Parameter Values
...
##### §10.2.4.3 Const Expression Evaluation
...
##### §10.2.4.4 Usage in Type Expressions
...
#### §10.2.5 Grant Parameters [generic.parameter.grant]

##### §10.2.5.1 Declaration and Bounds
...
##### §10.2.5.2 Grant Parameter Bounds
...
##### §10.2.5.3 Integration with Contractual Sequents
...
##### §10.2.5.4 Grant Parameter Inference
...
#### §10.2.6 Parameter Ordering and Defaults

##### §10.2.6.1 Parameter Order
...
##### §10.2.6.3 Default Value Constraints
...
#### §10.2.7 Explicit Type Arguments (Turbofish)
...
##### §10.2.7.1 Partial Explicit Arguments
...
##### §10.2.9.1 Type Parameter Semantics
...
##### §10.2.9.2 Const Parameter Semantics
...
##### §10.2.9.3 Grant Parameter Semantics
...
#### §10.2.11 Conformance Requirements
