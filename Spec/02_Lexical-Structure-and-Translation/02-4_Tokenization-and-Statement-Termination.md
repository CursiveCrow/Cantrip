...
[1] This clause refines the behaviour of the lexer around newline handling, statement continuation, and the maximal-munch rule used to recognise multi-character operators. It builds on the token categories introduced in §2.3 [lex.tokens] and defines when newline tokens terminate statements implicitly.
