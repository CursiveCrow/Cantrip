...
[4] Primitive type tokens follow this grammar (complete grammar: Annex A §A.3):
...
[5] These identifiers are reserved (§6.6). Attempting to redeclare or shadow them is ill-formed (diagnostic E07-001).
...
$$
\forall T \in \text{IntegerTypes}.\; T : \text{Copy}
\tag{Prop-Int-Copy}
$$

Integer moves are bitwise copies governed by the permission of the enclosing place (§12.4).
