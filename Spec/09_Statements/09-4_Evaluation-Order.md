...
**Section**: §9.4 Evaluation Order, Sequencing, Short-Circuit, and Divergence  
**Stable label**: [stmt.order]  
**Forward references**: §9.1 [stmt.fundamental], §9.2 [stmt.simple], §9.3 [stmt.control], Clause 8 [expr]

---

### §9.4 Evaluation Order, Sequencing, Short-Circuit, and Divergence [stmt.order]
