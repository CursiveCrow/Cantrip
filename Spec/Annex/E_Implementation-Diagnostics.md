...
[ Note: Clause 08 diagnostics are reserved for expression typing, evaluation, and pattern matching errors. Full diagnostic catalog will be added when Clause 08 is finalized.
— end note ]
...
##### §E.5.1.8 Clause 11: Memory Model, Regions, and Permissions

**Subsection §11.3: Regions**

| Code    | Section | Description                                   | Severity |
| ------- | ------- | --------------------------------------------- | -------- |
| E11-101 | §11.3.3 | Region-allocated value escapes region         | E        |
| E11-102 | §11.3.6 | Invalid caret stacking (too many ^ for depth) | E        |
...
- **E10-xxx**: Reserved for Clause 10 (Generics and Predicates).
- **E11-xxx**: Reserved for Clause 11 (Memory Model, Regions, and Permissions).
- **E12-xxx**: Reserved for Clause 12 (Contracts).
- **E13-xxx**: Reserved for Clause 13 (Witness System).
