...
**Section**: §13.5 Dispatch Semantics
...
### §13.5 Dispatch Semantics [witness.dispatch]
...
#### §13.5.2 Method Invocation Syntax [witness.dispatch.syntax]
...
#### §13.5.3 Dispatch Algorithm [witness.dispatch.algorithm]
...
#### §13.5.4 Dynamic Dispatch Evaluation [witness.dispatch.evaluation]
...
#### §13.5.5 Method Resolution [witness.dispatch.resolution]
...
#### §13.5.6 Performance Characteristics [witness.dispatch.performance]
...
#### §13.5.7 Grant Propagation [witness.dispatch.grants]
...
#### §13.5.8 Diagnostics [witness.dispatch.diagnostics]
...
#### §13.5.9 Conformance Requirements [witness.dispatch.requirements]
