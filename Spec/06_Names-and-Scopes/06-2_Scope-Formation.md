...
#### §6.2.1 Overview [name.scope.overview]
...
[4] The canonical forms for `procedure_body` and `statement` appear in Clause 9; `compilation_unit` is defined in §2.5.2; `region_block` is elaborated in §12.3.
