...
**Section**: §6.4 Name Lookup
**Stable label**: [name.lookup]  
**Forward references**: §4.4 [module.export], §5.6 [decl.visibility], §6.5 [name.ambiguity], §6.6 [name.predeclared], Annex A.7 [grammar.declaration]

---

### §6.4 Name Lookup [name.lookup]

#### §6.4.1 Overview [name.lookup.overview]
...
- **E06-400** — Ambiguous identifier (multiple imported bindings). See §6.5 for disambiguation strategies.
- **E06-401** — Undefined identifier (not found in any scope).
- **E06-402** — Prefix of a qualified name is not a module or type.
