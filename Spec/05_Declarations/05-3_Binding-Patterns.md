...
**Section**: §5.3 Binding Patterns
**Stable label**: [decl.pattern]  
**Forward references**: §5.2 [decl.variable], Clause 7 §7.3 [type.composite], Clause 8 §8.4 [expr.structured]
...
[2] Patterns currently apply only to variable bindings (§5.2). Other constructs (parameters, match expressions) reference their own pattern grammars when available.
