...
### §14.4 Synchronization Primitives [concurrency.synchronization]
...
#### §14.4.2 Mutex (Mutual Exclusion Lock)

##### §14.4.2.1 Mutex Modal Type
...
##### §14.4.2.3 Synchronization Semantics
...
#### §14.4.3 Channel (Message Passing)

##### §14.4.3.1 Channel Modal Type
...
##### §14.4.3.3 Synchronization Semantics
...
#### §14.4.4 RwLock (Read-Write Lock)

##### §14.4.4.1 RwLock Modal Type
...
Violating type constraints produces diagnostic E14-300.
...
#### §14.4.6 Conformance Requirements
...
8. Emit diagnostics E14-300, E14-301 for constraint violations
