...
**Section**: §10.6 Resolution and Monomorphization
...
#### §10.6.2 Resolution Algorithm [generic.resolution.algorithm]

##### §10.6.2.1 Resolution Overview
...
[5] Resolution attempts these strategies in order. If all fail, diagnostic E10-601 requests explicit type arguments.

##### §10.6.2.2 Resolution Judgment
...
##### §10.6.2.3 Explicit Type Arguments
...
##### §10.6.2.4 Type Inference from Arguments
...
##### §10.6.2.5 Type Inference from Context
...
##### §10.6.2.6 Const Parameter Inference
...
##### §10.6.2.7 Grant Parameter Inference
...
##### §10.6.2.8 Inference Failure

[18] When inference cannot determine a unique solution, the compiler emits diagnostic E10-601 requesting explicit type arguments:

$$
\frac{\text{resolve}(\Gamma, e, \langle\alpha_1, \ldots\rangle) = \text{ambiguous}}{\text{ERROR E10-601: cannot infer type arguments}}
\tag{Resolve-Fail}
$$
...
#### §10.6.3 Bound Checking [generic.resolution.bounds]
...
#### §10.6.4 Monomorphization [generic.resolution.monomorphization]
...
##### §10.6.4.2 Monomorphization Process
...
##### §10.6.4.3 Distinct Instantiations
...
##### §10.6.4.4 Code Sharing and Optimization
...
##### §10.6.4.5 Monomorphization and Behaviors
...
#### §10.6.5 Associated Type Resolution [generic.resolution.assoc]

##### §10.6.5.1 Projection Resolution
...
[36] Cyclic projections are detected during resolution and produce diagnostic E10-606.
...
#### §10.6.6 Zero-Cost Abstraction [generic.resolution.zerocost]

##### §10.6.6.1 Zero-Cost Guarantee
...
##### §10.6.6.2 Code Size Implications
...
[41] Implementations may apply code sharing optimizations (§10.6.4.4) provided semantics are preserved. Programs requiring minimal code size should limit generic usage or use dynamic dispatch via witnesses (Clause 13).

#### §10.6.7 Behavior Method Resolution [generic.resolution.predicate]

##### §10.6.7.1 Resolution Algorithm
...
##### §10.6.7.3 Blanket Implementation Resolution
...
#### §10.6.8 Constraint Solving [generic.resolution.constraints]

##### §10.6.8.1 Constraint Generation
...
[53] The principal type is unique when it exists. Ambiguous cases where no principal type exists produce diagnostic E10-610.

#### §10.6.9 Monomorphization Instantiation [generic.resolution.instantiation]

##### §10.6.9.1 Instantiation Cache
...
##### §10.6.9.2 Recursive Instantiation
...
##### §10.6.9.3 Monomorphization Limits
...
#### §10.6.10 Diagnostics [generic.resolution.diagnostics]
...
#### §10.6.11 Examples [generic.resolution.examples]

**Example 10.6.11.1 (Complete resolution example):**

```cursive
predicate Converter<U> {
    procedure convert(~): U
    {
...
predicate Converter<string@Managed> for i32 {
...
#### §10.6.12 Conformance Requirements [generic.resolution.requirements]
