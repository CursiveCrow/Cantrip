...
**Section**: §10.5 Behavior Implementations and Coherence
...
### §10.5 Behavior Implementations and Coherence [generic.implementation]
...
#### §10.5.2 Inline Implementation Syntax [generic.implementation.inline]
...
```ebnf
predicate_implementation
    ::= visibility_modifier? "predicate" behavior_name generic_params?
...
#### §10.5.4 Implementation Requirements [generic.implementation.requirements]

##### §10.5.4.1 Completeness
...
##### §10.5.4.2 Procedure Signature Compatibility
...
##### §10.5.4.3 Associated Type Specification
...
#### §10.5.5 Blanket Implementations [generic.implementation.blanket]
...
##### §10.5.5.4 Resolution with Blanket Implementations
...
#### §10.5.6 Orphan Rule [generic.implementation.orphan]
...
##### §10.5.6.2 Outermost Type Constructor
...
[ Rationale: The orphan rule prevents conflicting implementations from different modules. Without it, two modules could each implement the same behavior for the same external type, causing ambiguity. By requiring local definition of either the behavior or the type, coherence is maintained across separate compilation units.
— end rationale ]

##### §10.5.6.4 Orphan Rule for Blanket Implementations
...
#### §10.5.7 Coherence Rule [generic.implementation.coherence]

##### §10.5.7.1 Coherence Statement
...
##### §10.5.7.3 Blanket Implementation Overlap
...
#### §10.5.8 No Specialization [generic.implementation.specialization]
...
#### §10.5.9 Method Override and Associated Type Override [generic.implementation.override]

##### §10.5.9.1 Procedure Override
...
##### §10.5.9.2 Using Inherited Defaults
...
##### §10.5.9.3 Associated Type Override
...
#### §10.5.10 Generic Implementations [generic.implementation.generic]

##### §10.5.10.1 Generic Behavior for Generic Type
...
predicate Converter<string@Managed> for<T> Wrapper<T> where T: Display {
...
##### §10.5.10.2 Parameter Substitution
...
#### §10.5.11 Diagnostics [generic.implementation.diagnostics]
...
#### §10.5.12 Examples [generic.implementation.examples]
...
predicate Display for<T> (T, T) where T: Display {
    procedure show(~): string@View
    {
...
#### §10.5.13 Conformance Requirements [generic.implementation.requirements]
...
**Previous**: §10.4 Behaviors: Declarations and Items (§10.4 [generic.predicate]) | **Next**: §10.6 Resolution and Monomorphization (§10.6 [generic.resolution])
