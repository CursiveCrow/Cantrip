...
**Section**: §6.5 Disambiguation and Ambiguity
**Stable label**: [name.ambiguity]  
**Forward references**: §4.2 [module.syntax], §4.4 [module.export], §5.6 [decl.visibility], §6.4 [name.lookup], Annex E §E.5 [implementation.diagnostics]

---

### §6.5 Disambiguation and Ambiguity [name.ambiguity]

#### §6.5.1 Overview [name.ambiguity.overview]
