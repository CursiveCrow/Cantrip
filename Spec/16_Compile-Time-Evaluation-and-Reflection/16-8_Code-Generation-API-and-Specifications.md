...
**Section**: §16.8 Code Generation API and Specifications  
...
### §16.8 Code Generation API and Specifications [comptime.codegen.api]

#### §16.8.1 Overview [comptime.codegen.api.overview]
...
#### §16.8.2 TypeRef Enumeration [comptime.codegen.api.typeref]

##### §16.8.2.1 TypeRef Structure
...
#### §16.8.3 Specification Structures [comptime.codegen.api.specs]

##### §16.8.3.1 ProcedureSpec
...
#### §16.8.4 Codegen API Procedures [comptime.codegen.api.procedures]

##### §16.8.4.1 Declaration Generation
...
##### §16.8.4.2 Type Extension Procedures
...
#### §16.8.5 Complete Code Generation Examples [comptime.codegen.api.examples]

##### §16.8.5.1 Automatic Serialization
...
#### §16.8.6 Struct-of-Arrays Transformation [comptime.codegen.api.soa]
...
#### §16.8.7 Generated Code Validation [comptime.codegen.api.validation]

##### §16.8.7.1 Type Checking Phase
...
#### §16.8.8 Diagnostics [comptime.codegen.api.diagnostics]

[29] Code generation API diagnostics:

**Table 16.8 — Code generation API diagnostics**

| Code    | Condition                                        | Constraint |
| ------- | ------------------------------------------------ | ---------- |
| E16-210 | Generated procedure name collision               | [15]       |
| E16-211 | Generated type name collision                    | [16]       |
| E16-212 | Generated constant name collision                | [17]       |
| E16-213 | Procedure name collision on type                 | [19]       |
| E16-220 | TypeRef references non-existent type             | [22]       |
| E16-221 | add_procedure/add_function target not found      | [23]       |
| E16-230 | Generated code failed type checking              | [25]       |
| E16-231 | ProcedureSpec malformed (missing required field) | N/A        |
| E16-232 | TypeSpec malformed (missing required field)      | N/A        |
| E16-233 | SequentSpec malformed (invalid grant identifier) | N/A        |

#### §16.8.9 Conformance Requirements [comptime.codegen.api.requirements]
