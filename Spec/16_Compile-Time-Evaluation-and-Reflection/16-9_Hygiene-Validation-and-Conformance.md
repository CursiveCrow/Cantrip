...
**Section**: §16.9 Hygiene, Validation, and Conformance  
...
### §16.9 Hygiene, Validation, and Conformance [comptime.conformance]

#### §16.9.1 Overview [comptime.conformance.overview]
...
#### §16.9.2 Hygienic Code Generation [comptime.conformance.hygiene]

##### §16.9.2.1 Name Collision Problem
...
##### §16.9.2.4 Public Name Documentation
...
#### §16.9.3 Generated Code Validation [comptime.conformance.validation]

##### §16.9.3.1 Validation Requirements
...
#### §16.9.4 Consolidated Conformance Requirements [comptime.conformance.requirements]

##### §16.9.4.1 Comptime Execution Requirements
...
##### §16.9.4.2 Reflection Requirements
...
##### §16.9.4.3 Code Generation Requirements
...
#### §16.9.5 Complete Diagnostic Catalog [comptime.conformance.diagnostics]

[23] Clause 16 defines diagnostic codes E16-001 through E16-299 organized into ranges:

**Comptime execution (E16-001 through E16-099):**

| Code    | Condition                                         |
| ------- | ------------------------------------------------- |
| E16-001 | Runtime grant in comptime context                 |
| E16-002 | Non-pure operation in comptime                    |
| E16-003 | Recursion depth exceeded                          |
| E16-004 | Evaluation steps exceeded                         |
| E16-005 | Memory allocation exceeded                        |
| E16-006 | String size exceeded                              |
| E16-007 | Runtime-only construct in comptime                |
| E16-008 | Collection size exceeded                          |
| E16-009 | Non-deterministic operation                       |
| E16-010 | Comptime assertion failed                         |
| E16-011 | Comptime error (fatal)                            |
| E16-012 | Comptime warning                                  |
| E16-020 | Cyclic comptime dependency                        |
| E16-021 | Cyclic comptime dependency (duplicate of E16-020) |
| E16-030 | Comptime assertion failed (alias of E16-010)      |
| E16-031 | Comptime error (alias of E16-011)                 |
| E16-032 | Comptime warning (alias of E16-012)               |

**Reflection (E16-100 through E16-199):**

| Code    | Condition                            |
| ------- | ------------------------------------ |
| E16-100 | [[reflect]] misplaced                |
| E16-101 | Reflection on non-reflected type     |
| E16-110 | Reflection in runtime context        |
| E16-111 | Private field access cross-module    |
| E16-112 | Reflection on uninstantiated generic |
| E16-120 | Field not found                      |
| E16-121 | Procedure not found                  |
| E16-122 | Variant not found                    |

**Code generation (E16-200 through E16-299):**

| Code    | Condition                                    |
| ------- | -------------------------------------------- |
| E16-200 | Quote in runtime context                     |
| E16-201 | Interpolation not compile-time evaluable     |
| E16-202 | Interpolated value not embeddable            |
| E16-203 | Generated code failed type checking          |
| E16-210 | Generated procedure name collision           |
| E16-211 | Generated type name collision                |
| E16-212 | Generated constant name collision            |
| E16-213 | Procedure collision on type                  |
| E16-220 | TypeRef invalid                              |
| E16-221 | Codegen target not found                     |
| E16-230 | Generated code type error (alias of E16-203) |
| E16-231 | ProcedureSpec malformed                      |
| E16-232 | TypeSpec malformed                           |
| E16-233 | SequentSpec malformed                        |
| E16-240 | Quote interpolation malformed                |

[24] All diagnostics follow the canonical format `E16-[NNN]` per §1.6.6 [intro.document.diagnostics].

#### §16.9.6 Integration Summary [comptime.conformance.integration]
...
#### §16.9.7 Best Practices [comptime.conformance.practices]

##### §16.9.7.1 Recommended Patterns
...
#### §16.9.8 Complete Conformance Requirements [comptime.conformance.complete]
...
#### §16.9.9 Quality of Implementation Recommendations [comptime.conformance.quality]
...
#### §16.9.10 Examples [comptime.conformance.examples]
...
#### §16.9.11 Conformance Summary [comptime.conformance.summary]
