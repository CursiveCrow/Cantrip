...
**Section**: §16.6 Type Reflection and Metadata Queries  
**Stable label**: [comptime.reflect.queries]  
**Forward references**: §16.5 [comptime.reflect.optin], §16.8 [comptime.codegen.api], Clause 3 §3.5 [basic.align], Clause 5 §5.5 [decl.type], Clause 7 §7.2 [type.primitive], Clause 7 §7.3 [type.composite], Clause 7 §7.6 [type.modal], Clause 7 §7.8 [type.introspection], Clause 11 §11.6 [memory.layout]

---

### §16.6 Type Reflection and Metadata Queries [comptime.reflect.queries]

#### §16.6.1 Overview [comptime.reflect.queries.overview]

[1] This subclause specifies the complete API for querying type metadata at compile time. Reflection queries build upon the basic type introspection in §7.8 and the opt-in mechanism in §16.5 to provide comprehensive access to type structure.
...
#### §16.6.2 Core Type Reflection [comptime.reflect.queries.core]

##### §16.6.2.1 TypeInfo Structure
...
- Type `T` shall be marked with `[[reflect]]` (diagnostic E16-101 if not)
- Shall be called in comptime context (diagnostic E16-110 if runtime)
- Generic type `T` shall be instantiated with concrete arguments (diagnostic E16-112 if uninstantiated)
...
#### §16.6.3 Field Reflection [comptime.reflect.queries.fields]

##### §16.6.3.1 FieldInfo Structure
...
##### §16.6.3.2 Field Query Procedures
...
#### §16.6.4 Procedure Reflection [comptime.reflect.queries.procedures]

##### §16.6.4.1 ProcedureInfo Structure
...
##### §16.6.4.2 Procedure Query Procedures
...
#### §16.6.5 Enum Variant Reflection [comptime.reflect.queries.variants]

##### §16.6.5.1 VariantInfo Structure
...
##### §16.6.5.2 Variant Query Procedures
...
#### §16.6.6 Modal State Reflection [comptime.reflect.queries.modal]

##### §16.6.6.1 Modal Reflection Structures
...
##### §16.6.6.2 Modal Query Procedures
...
#### §16.6.7 Advanced Reflection Patterns [comptime.reflect.queries.patterns]

##### §16.6.7.1 Layout Validation
...
##### §16.6.7.2 Component Registration
...
##### §16.6.7.3 Automatic Getter Generation
...
#### §16.6.8 Reflection Constraints Summary [comptime.reflect.queries.constraints]

[30] All reflection query procedures share these constraints:

**Opt-in requirement:**

[31] Type `T` shall be marked with `[[reflect]]` attribute (diagnostic E16-101).

**Comptime context:**

[32] Reflection queries shall execute in comptime contexts only (diagnostic E16-110).

**Concrete types:**

[33] Generic types shall be instantiated with concrete arguments (diagnostic E16-112).
...
#### §16.6.9 Diagnostics [comptime.reflect.queries.diagnostics]

[35] Type reflection query diagnostics:

**Table 16.6 — Reflection query diagnostics**

| Code    | Condition                                   | Section   |
| ------- | ------------------------------------------- | --------- |
| E16-101 | Reflection on type without [[reflect]]      | §16.5[7]  |
| E16-110 | Reflection query in runtime context         | §16.5[18] |
| E16-111 | Private field details accessed cross-module | §16.5[10] |
| E16-112 | Reflection on uninstantiated generic type   | §16.5[12] |
| E16-120 | Field not found during query                | N/A       |
| E16-121 | Procedure not found during query            | N/A       |
| E16-122 | Variant not found during query              | N/A       |

#### §16.6.10 Conformance Requirements [comptime.reflect.queries.requirements]
...
3. Include field offsets computed per §11.6 [memory.layout]
...
8. Emit diagnostics E16-101, E16-110, E16-111, E16-112, E16-120, E16-121, E16-122
...
**Previous**: §16.5 Reflection Opt-In and Attributes (§16.5 [comptime.reflect.optin]) | **Next**: §16.7 Quote Expressions and Interpolation (§16.7 [comptime.quote])
