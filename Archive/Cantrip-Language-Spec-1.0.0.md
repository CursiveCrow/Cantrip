...
**Purpose:** Formal specification and normative reference.
...
2. **One Correct Way** - Where possible there shoule be one, and only one, obvious way to accomplish a task.
...
4. **LLM-native** - LLM-focused design to improve agentic and pair-programming with LLM code generation.
...
51. [Overview](#56-overview)
52. [Declarations and Linkage](#57-declarations-and-linkage)
53. [Type Mappings](#58-type-mappings)
54. [Ownership and Allocation Across FFI](#59-ownership-and-allocation-across-ffi)
55. [Callbacks from C into Cantrip](#60-callbacks-from-c-into-cantrip)
56. [Errors and Panics](#61-errors-and-panics)
57. [Inline Assembly (Reserved)](#62-inline-assembly-reserved)


58. [Machine‑Readable Output](#55-machine-readable-output)
59. [Compiler Architecture](#51-compiler-architecture)
60. [Error Reporting](#52-error-reporting)
61. [Package Management](#53-package-management)
62. [Testing Framework](#54-testing-framework)
